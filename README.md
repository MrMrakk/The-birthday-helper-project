# The-birthday-helper-project
The Birthday Assistant project, which will remind you of the birthdays of your friends, colleagues and acquaintances. He will also help you choose a gift in honor of the holiday.
...
### 3. Перейти по ссылке https://openrouter.ai/settings/keys и получить ключ. Его необходимо вставить в пустые кавычки:
```python
API_KEY = ""
```

### 4. В Телеграм найти бота @BotFather и создать своего бота. Далее скопировать его ключ и вставить в пустые кавычки:
```python
API_TOKEN = ""
```

### 5. Запустить проект и проверить роботоспособность. после начала работы будет создана база данных.
