# Ассистент для дней рождения
Проект «Помощник по дням рождения» напомнит вам о днях рождения ваших друзей, коллег и знакомых. Он также поможет вам выбрать подарок в честь праздника.
